...
public class SalesByProductRow {
    ...
    public SalesByProductRow(String productoNombre, BigDecimal cantidad, BigDecimal ingreso) {
    ...
    public static class Builder {
        ...
        public SalesByProductRow build() {
            return new SalesByProductRow(productoNombre, cantidad, ingreso);
        }
    }
}
